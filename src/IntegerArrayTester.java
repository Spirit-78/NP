...
final class IntegerArray {
    ...
    public int getElementAt(int i){return a[i];}
    public int sum(){return Arrays.stream(this.a).sum();}
    public double average(){return Arrays.stream(this.a).average().getAsDouble();}
    public IntegerArray getSorted(){
        int []tmp = Arrays.copyOf(this.a,a.length);
        return new IntegerArray(Arrays.stream(tmp).flatMap(IntStream::of).sorted().toArray());
